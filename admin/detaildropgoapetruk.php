...
function cari($keyword, $keyword2) {
 ...
 $ambil = mysqli_query($conn, "SELECT * FROM drop_petruk ORDER BY tanggal DESC"); 
...
<head>
    ...
    <title>Detail Laporan Drop Goa Petruk</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Detail Laporan Drop Goa Petruk</h1>
            </li>
            ...
            <table border="1" width="70%" align="center">
                ...
                <tr>
                    <td align="center"><?= $i; ?></td>
                        ...
                        <td align="center">
                            <a href="dropconhapus/hapuspetruk.php?id=<?php echo $row["id"] ?>" onclick="return confirm('anda yangkin menghapus data ini?');">Hapus</a>
                        </td>
                </tr>
                <?php $i++; ?>
                <?php endforeach; ?>
