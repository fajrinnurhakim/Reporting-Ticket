...
function cari($keyword, $keyword2) {
    $query = "SELECT * FROM drop_petanahan
                WHERE
 ...
 $ambil = mysqli_query($conn, "SELECT * FROM drop_petanahan ORDER BY tanggal DESC"); 
...
<head>
    ...
    <title>Detail Laporan Drop Pantai Petanahan</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Detail Laporan Drop Pantai Petanahan</h1>
            </li>
    ...
    <div id="main">
        <form action="lapor.php" method="POST">
            <table border="1" width="70%" align="center">
                <tr>
                    <th colspan="17">DAFTAR LAPORAN DROP TIKET PANTAI PETANAHAN</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center"><?= $i; ?></td>
                        ...
                        <td align="center">
                            <a href="dropconhapus/hapuspetanahan.php?id=<?php echo $row["id"] ?>" onclick="return confirm('anda yangkin menghapus data ini?');">Hapus</a>
                        </td>
                </tr>
                <?php $i++; ?>
                <?php endforeach; ?>
