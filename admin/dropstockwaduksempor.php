...
function regis($data)
{
    ...
    mysqli_query($conn, "INSERT INTO drop_waduk_sempor VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
    ...
    if (regis($_POST) > 0) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detaildropwaduksempor.php'
        </script>";
    } else {
...
<head>
    ...
    <title>Drop Stock Waduk Sempor</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Drop Stock Tiket Waduk Sempor</h1>
            </li>
