...
function regis($data)
{
    ...
    mysqli_query($conn, "INSERT INTO drop_karangbolong VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
    ...
    if (regis($_POST) > 0) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detaildroppantaikarangbolong.php'
        </script>";
    } else {
...
<head>
    ...
    <title> Drop Stock Pantai Karangbolong</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Drop Stock Tiket Pantai Karangbolong</h1>
            </li>
