...
function regis($data)
{
    ...
    mysqli_query($conn, "INSERT INTO drop_krakal VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
    ...
    if (regis($_POST) > 0) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detaildropairpanaskrakal.php'
        </script>";
    } else {
...
<head>
    ...
    <title> Drop Stock PAP Krakal</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Drop Stock Tiket PAP Krakal</h1>
            </li>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="row">
                <div class="col-25">
                    <label for="fname">Jumlah Dropping Retribusi Tiket Mandi</label>
                </div>
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_mandi" placeholder="Masukkan Jumlah Tiket Mandi">
                </div>
            </div>
