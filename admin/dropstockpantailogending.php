...
function regis($data)
{
    ...
    mysqli_query($conn, "INSERT INTO drop_logending VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
    ...
    if (regis($_POST) > 0) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detaildroppantailogending.php'
        </script>";
    } else {
...
<head>
    ...
    <title> Drop Stock Pantai Logending</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Drop Stock Tiket Pantai Logending</h1>
            </li>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="row">
                <div class="col-25">
                    <label for="fname">Jumlah Dropping Retribusi Tiket Atv</label>
                </div>
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_atv" placeholder="Masukkan Jumlah Tiket Atv">
                </div>
            </div>

            <div class="row">
                <div class="col-25">
                    <label for="fname">Jumlah Dropping Retribusi Tiket Perahu</label>
                </div>
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_perahu" placeholder="Masukkan Jumlah Tiket Perahu">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_kuda" placeholder="Masukkan Jumlah Tiket Kuda">
                </div>
            </div>
