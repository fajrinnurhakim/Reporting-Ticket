...
function cari($keyword, $keyword2) {
    $query = "SELECT * FROM drop_wadaslintang
                WHERE
 ...
 $ambil = mysqli_query($conn, "SELECT * FROM drop_wadaslintang ORDER BY tanggal DESC"); 
...
<head>
    ...
    <title>Detail Laporan Drop Waduk Wadaslintang</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Detail Laporan Drop Waduk Wadaslintang</h1>
            </li>
    ...
    <div id="main">
        <form action="lapor.php" method="POST">
            <table border="1" width="70%" align="center">
                <tr>
                    <th colspan="17">DAFTAR LAPORAN DROP TIKET WADUK WADASLINTANG</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center"><?= $i; ?></td>
                        ...
                        <td align="center">
                          <a href="dropconhapus/hapuswadaslintang.php?id=<?php echo $row["id"] ?>" onclick="return confirm('anda yangkin menghapus data ini?');">Hapus</a>
                        </td>
                </tr>
                <?php $i++; ?>
                <?php endforeach; ?>
