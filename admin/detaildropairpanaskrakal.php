...
$ambil = mysqli_query($conn, "SELECT * FROM drop_krakal ORDER BY tanggal DESC");
...
<head>
    ...
    <title>Detail Laporan Drop PAP Krakal</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Detail Laporan Drop PAP Krakal</h1>
            </li>
            ...
            <table id="example" class="table table-striped table-bordered" style="width:100%">
                ...
                <?php foreach ($ambil as $row) : ?>
                    <tr>
                        ...
                        <td align="center">
                            <a href="dropconhapus/hapusairpanaskrakal.php?id=<?php echo $row["id"] ?>" onclick="return confirm('anda yangkin menghapus data ini?');">Hapus</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
