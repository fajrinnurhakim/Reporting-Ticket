...
function regis($data)
{
    ...
    mysqli_query($conn, "INSERT INTO drop_petanahan VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
    ...
    if (regis($_POST) > 0) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detaildroppantaipetanahan.php'
        </script>";
    } else {
...
<head>
    ...
    <title> Drop Stock Pantai Petanahan</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Drop Stock Tiket Pantai Petanahan</h1>
            </li>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="row">
                <div class="col-25">
                    <label for="fname">Jumlah Dropping Retribusi Tiket Kuda Andong</label>
                </div>
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_kuda" placeholder="Masukkan Jumlah Tiket Kuda Andong">
                </div>
            </div>
