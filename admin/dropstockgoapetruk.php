...
function regis($data)
{
    ...
    mysqli_query($conn, "INSERT INTO drop_petruk VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
    ...
    if (regis($_POST) > 0) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detaildropgoapetruk.php'
        </script>";
    } else {
...
<head>
    ...
    <title> Drop Stock Goa Petruk</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Drop Stock Tiket Goa Petruk</h1>
            </li>
