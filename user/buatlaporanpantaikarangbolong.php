...
function regis($data) {
    ...
    mysqli_query($conn, "INSERT INTO laporan_karangbolong VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
  ...
  if (regis($_POST) > 0 ) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detailpenjualanpantaikarangbolong.php'
        </script>";
...
<head>
    ...
    <title> Laporan Pantai Karangbolong</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Buat Laporan Pantai Karangbolong</h1>
            </li>
