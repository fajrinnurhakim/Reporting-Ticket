...
function regis($data) {
    ...
    mysqli_query($conn, "INSERT INTO laporan_waduk_sempor VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
  ...
  if (regis($_POST) > 0 ) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detailpenjualanwaduksempor.php'
        </script>";
...
<head>
    ...
    <title>Laporan Waduk Sempor</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Buat Laporan Waduk Sempor</h1>
            </li>
