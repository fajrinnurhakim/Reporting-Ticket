...
function regis($data) {
    ...
    $tiket_fotografer = htmlspecialchars($data["tiket_fotografer"]);
    ...
    mysqli_query($conn, "INSERT INTO laporan_jatijajar VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
  ...
  if (regis($_POST) > 0 ) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detailpenjualangoajatijajar.php'
        </script>";
...
<head>
    ...
    <title>Laporan Goa Jatijajar</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Buat Laporan Goa Jatijajar</h1>
            </li>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="row">
                <div class="col-25">
                    <label for="fname">Jumlah Tiket Fotografer</label>
                </div>
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_fotografer"
                        placeholder="Masukkan Jumlah Tiket Fotografer yang Terjual">
                </div>
            </div>
