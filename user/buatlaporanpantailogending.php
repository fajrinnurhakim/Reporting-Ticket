...
function regis($data) {
    ...
    $tiket_atv = htmlspecialchars($data["tiket_atv"]);
    $tiket_perahu = htmlspecialchars($data["tiket_perahu"]);
    ...
    mysqli_query($conn, "INSERT INTO laporan_logending VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
  ...
  if (regis($_POST) > 0 ) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detailpenjualanpantailogending.php'
        </script>";
...
<head>
    ...
    <title>Laporan Pantai Logending</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Buat Laporan Pantai Logending</h1>
            </li>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_dewasa"
                        placeholder="Masukkan Jumlah Tiket Dewasa yang Terjual">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_anak"
                        placeholder="Masukkan Jumlah Tiket Anak yang Terjual">
                </div>
            </div>

            <div class="row">
                <div class="col-25">
                    <label for="fname">Jumlah Tiket ATV</label>
                </div>
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_atv"
                        placeholder="Masukkan Jumlah Tiket ATV yang Terjual">
                </div>
            </div>

            <div class="row">
                <div class="col-25">
                    <label for="fname">Jumlah Tiket Perahu</label>
                </div>
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_perahu"
                        placeholder="Masukkan Jumlah Tiket Perahu yang Terjual">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_kuda"
                        placeholder="Masukkan Jumlah Tiket Kuda yang Terjual">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_r2"
                        placeholder="Masukkan Jumlah Tiket Roda 2 yang Terjual">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_r4"
                        placeholder="Masukkan Jumlah Tiket Roda 4 yang Terjual">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_r6"
                        placeholder="Masukkan Jumlah Tiket Roda 6 yang Terjual">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_retribusi_kios"
                        placeholder="Masukkan Jumlah Tiket Retribusi Sampah Kios yang Terjual">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_retribusi_los"
                        placeholder="Masukkan Jumlah Tiket Retribusi Sampah Los">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_retribusi_lesehan"
                        placeholder="Masukkan Jumlah Tiket Retribusi Sampah Lesehan">
                </div>
            </div>
            &nbsp;
