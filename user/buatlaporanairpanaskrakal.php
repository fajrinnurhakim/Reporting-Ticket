...
function regis($data)
{
    ...
    $tiket_mandi = htmlspecialchars($data["tiket_mandi"]);
    ...
    mysqli_query($conn, "INSERT INTO laporan_krakal VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
    ...
    if (regis($_POST) > 0) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detailpenjualanairpanaskrakal.php'
        </script>";
    } else {
...
<head>
    ...
    <title> Laporan PAP Krakal</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Buat Laporan Tiket PAP Krakal</h1>
            </li>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="row">
                <div class="col-25">
                    <label for="fname">Jumlah Tiket Mandi yang Terjual</label>
                </div>
                <div class="col-75">
                    <input type="number" id="fname" name="tiket_mandi" placeholder="Masukkan Jumlah Tiket Mandi yang Terjual">
                </div>
            </div>
            ...
            <div class="row">
                <center>
                    <button class="button" type="submit" name="add" style="width:25%;cursor: pointer;">Kirim</button>
                </center>
            </div>
