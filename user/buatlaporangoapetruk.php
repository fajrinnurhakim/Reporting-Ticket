...
function regis($data) {
    ...
    mysqli_query($conn, "INSERT INTO laporan_petruk VALUES(
        NULl, 
        '$nama_pelapor',
        '$tanggal',
        '$tiket_dewasa',
...
if (isset($_POST["add"])) {
  ...
  if (regis($_POST) > 0 ) {
        ...
        echo "<script>
            alert('Berhasil!');
            window.location.href='detailpenjualangoapetruk.php'
        </script>";
...
<head>
    ...
    <title> Laporan Goa Petruk</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li>
                <h1 class="judulheader" href="#">Buat Laporan Goa Petruk</h1>
            </li>
